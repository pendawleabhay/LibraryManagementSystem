...
<div id="main" class="container"> 	
	...
	<!-- <form name="loginform" id="loginform" action="/book/updateBook" method="post" class="wpl-track-me"> --> 
		...
		<p class="login-username">
		<label for="user_login">Author</label> 
			<input type="text" name="author" id="author" class="input" placeholder="Author Name" value="${book.author}" size="20" />
		</p> 
		...
		<label for="user_login">Copies Available</label> 
			<input type="text" name="copies_available" id="copies_available" class="input" placeholder="Copies Available" value="${book.copies_available}" size="20" />
		</p>
		...
		<p class="login-submit">
			<input type="submit" name="wp-submit" id="wp-submit" class="button-primary" value="Update Book" />
		</p> 	
	</form> 
</div>
